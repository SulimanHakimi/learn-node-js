...
form.addEventListener("submit", (e) => {
  e.preventDefault();
  fetch(
    `https://www.omdbapi.com/?apikey=59f796d9&s=${e.target.search.value}`
  )
    ...
    .then((data) => {
      ...
      if (data.Response) {
        ...
        document.querySelector(".movie-o-search").style.display = "none";
      ...
      <div class="card-content">
        ...
        <div class="time-gu">
          <span class="time-du">117 min</span>
          <span class="gan">Action, Drama, Sci-fi</span>
          <span class="add-fiv"
            ><svg
              width="16"
              class="button"
        ...
        <p class="movie-des">
          ...
          creator. Lorem ipsum, dolor sit amet consectetur adipisicing
          elit. Consequuntur tempore magnam autem eos nihil quibusdam quo
          illo eum accusamus suscipit.
        </p>
      </div>
    </div>`;
        });
        ...
        document.querySelector(".not-found-movie").style.display =
          "block";
      }
    });
});
